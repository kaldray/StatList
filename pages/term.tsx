    ...
    <>
      ...
      <Layout>
        <section className={term__container}>
          ...
          <p>
            L&apos;utilisateur est responsable de l&apos;utilisation qu&apos;il fait du site et des services proposés,
            et s&apos;engage à ne pas utiliser ceux-ci dans un but illégal ou contraire aux bonnes mœurs.
          </p>
          <p>
