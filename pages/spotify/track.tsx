...
import { TrackWrapper } from "../../src/Components/Spotify/TrackWrapper";

const PeriodChoice = dynamic(async () => await import("../../src/Components/PeriodChoice").then((res) => res.PeriodChoice));
...
const Track: NextPage = () => {
  ...
  return (
    <>
      ...
      />
      <TrackWrapper queryParams={queryParams} />
    </>
  );
};
